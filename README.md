...
A determined user could still download all audio files using a combination of the browser inspector (to find the audio source link structure), playlist export (to get components for all audio show paths), and `wget` in terminal.
