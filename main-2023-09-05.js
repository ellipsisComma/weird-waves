...
function countStats() {
	...
	seriesDurations.sort((a, b) => (b.duration - a.duration));

	for (const series of seriesDurations) {
		showCountList += "<dt>" + series.heading + "</dt><dd>" + (Math.round(series.duration / 3600 * 10) / 10).toFixed(1) + "</dd>";
	}
...
"<div><dt>hours of audio</dt><dd>" + Math.round(totalDuration / 3600) + "</dd></div>";
	...
	document.getElementById("series-show-stats").innerHTML = showCountList;
}
