...
<head>
	<title><xsl:value-of select="cocnat(atom:title, ' Feed')" /></title>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="./main.css?v=2025-01-19" />
	...
	<script src="./utilities.js?v=2024-12-15b"></script>
